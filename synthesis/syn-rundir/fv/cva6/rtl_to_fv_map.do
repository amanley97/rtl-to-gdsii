...
# Generated on: Thu Mar 13 19:22:03 UTC 2025 (Thu Mar 13 19:22:03 UTC 2025)
...
set_log_file fv/cva6/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/cva6 -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 -f  /moosefs/scratch/a599m019/rtl-to-gdsii/synthesis/Flist.cva6_synth
elaborate_design -golden -root {cva6} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/cva6/fv_map.v.gz
elaborate_design -revised -root {cva6}
...
#add_name_alias fv/cva6/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/cva6/rtl_to_fv_map.log
}
